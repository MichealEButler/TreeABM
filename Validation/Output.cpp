...
void Output::populations(int year, int elmNo, int pineNo, int oakNo, int alderNo, int hazelNo, int ashNo, int limeNo, int birchNo, int hornNo, int larchNo, int beechNo, int willowNo, int mapleNo, int pftNo)
{
  file << year << " ";
  file << elmNo << " ";
  file << pineNo << " ";
